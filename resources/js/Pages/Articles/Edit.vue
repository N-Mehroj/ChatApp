...
<script lang="ts">
    ...
    export default {
        ...
        computed: {
            pageTitle() {
                return this.article ? 'Редактирование статьи' : 'Добавить статью'
            }
        },
        data() {
            return {
        ...
        methods: {
            ...
            updateArticle() {
                this.$inertia.put(`/articles/${this.article.id}`, this.form)
            },
            createArticle() {
    ...
    <div class="grid grid-cols-12 gap-5 mt-5 intro-y">
        <div class="col-span-12 intro-y lg:col-span-8">
            ...
            <div class="p-5 mt-5 border rounded-md border-slate-200/60 dark:border-darkmode-400">
                ...
                <div class="mt-5">
                    <div class="mt-3">
                        <SingleFileUpload v-model="form.image" :folder="'articles'"/>
                    </div>
                </div>
            </div>
