<template>
    <h2 class="mt-10 text-lg font-medium intro-y">Список FAQ</h2>
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        >
            ...
            <div v-if="faqs.total" class="hidden mx-auto md:block text-slate-500">
                Показано с {{ faqs.from }} по {{ faqs.to }} из {{ faqs.total }} записей
            </div>
                ...
                <Table class="border-spacing-y-[10px] border-separate -mt-2">
                    <Table.Thead>
                        <Table.Tr>
                            ...
                            <Table.Th class="border-b-0 whitespace-nowrap">Тип страницы FAQ</Table.Th>
                    ...
                    <Table.Tbody>
                        ...
                        >
                            ...
                            >
                                <a :href="`/faqs/${faq.id}/edit`" class="font-medium whitespace-nowrap">
                                    {{ faq.id }}
                                </a>
                            </Table.Td>
                            <Table.Td
                            ...
                            >
                                <div class="flex items-center justify-center">
                                    <Link class="flex items-center mr-3" :href="`/faqs/${faq.id}/edit`">
                                    ...
                                    <a
                                        ...
                                        href="#"
                                        @click.prevent="deleteRecord(faq.id)"
                                    >
...
export default {
    ...
    computed: {
        faqList() {
            return this.faqs.data
        }
    },
    methods: {
        deleteRecord(id) {
            this.deleteRecordUrl = `/faqs/${id}`
