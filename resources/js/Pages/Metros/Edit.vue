	...
	<div class="grid grid-cols-12 gap-5 mt-5 intro-y">
		...
		<div class="col-span-12 lg:col-span-4">
			<div class="p-5 intro-y box">
				<div>
					<div class="mt-3">
						<item-select v-model="form.line" :label="'Линия метро'" :items="metroLines"  :name-value="'label_ru'" :id-value="'value'"/>
					</div>
				</div>
...
export default {
	...
	beforeMount() {
		if (this.metro) {
			this.form = this.metro
		}
	},
	computed: {
		pageTitle() {
			return this.metro ? 'Редактирование станции метро' : 'Добавление станции метро'
		}
	},
	methods: {
		updateOrCreate() {
		...
		update() {
			this.$inertia.put(`/handbook/metros/${this.metro.id}`, this.form)
		},
		create() {
			this.$inertia.post('/handbook/metros', this.form)
		}
	}
}
</script>
