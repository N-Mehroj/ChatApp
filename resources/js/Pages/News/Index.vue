...
<template>
    <div class="flex flex-col items-center mt-8 intro-y sm:flex-row">
        <h2 class="mr-auto text-lg font-medium"> Новости </h2>
        <div class="flex w-full mt-4 sm:w-auto sm:mt-0">
            <Link href="/news/create" class="btn btn-primary shadow-md mr-2">
                <Button variant="primary" class="mr-2 shadow-md"> Добавить новости </Button>
            </Link>
            ...
            >
                <Menu class="ml-3">
                    ...
                    <Menu.Items class="w-40">
                        <Menu.Item>
                            <Link class="flex items-center mr-3" :href="`/news/${newsItem.id}/edit`">
                        ...
                        <Menu.Item>
                            <a
                                ...
                                href="#"
                                @click.prevent="deleteRecord(newsItem.id)"
                            >
