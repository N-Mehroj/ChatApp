    ...
    <div class="grid grid-cols-12 gap-5 mt-5 intro-y">
        <div class="col-span-12 intro-y lg:col-span-8">
            ...
            <div class="p-5 mt-5 border rounded-md border-slate-200/60 dark:border-darkmode-400">
                ...
                <div class="mt-5">
                    <div class="mt-3">
                        <SingleFileUpload v-model="form.image" :folder="'promotions'"/>
                    </div>
                </div>
            </div>
...
export default {
    ...
    computed: {
        pageTitle() {
            return this.promotion ? 'Редактирование акции' : 'Добавить акцию'
        }
    },
    data() {
        return {
    ...
    methods: {
        ...
        updatePromotion() {
            this.$inertia.put(`/sale/promotions/${this.promotion.id}`, this.form)
        },
        createPromotion() {
            console.log(this.form)
            this.$inertia.post('/sale/promotions', this.form)
        },
        updateForm() {
            let fields = {
                title_ru: '',
