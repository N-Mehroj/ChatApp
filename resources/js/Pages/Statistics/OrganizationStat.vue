<template>
    <h2 class="mt-10 text-lg font-medium intro-y">Статистика по организациям</h2>
                ...
                <Table.Tbody>
                    ...
                    >
                        ...
                        <Table.Td
                            class="first:rounded-l-md last:rounded-r-md bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]"
                        >
                            {{  organization.products_view }}
                        </Table.Td>
                        <Table.Td
                            class="first:rounded-l-md last:rounded-r-md bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]"
                        >
                            {{ organization.products_show_phone }}
                        </Table.Td>
                        <Table.Td
                            class="first:rounded-l-md last:rounded-r-md bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]"
                        >
                            {{ organization.products_telegram_click }}
                        </Table.Td>
                    </Table.Tr>
                </Table.Tbody>
            </Table>
    ...
    data() {
        return {
            ...
            fields : [
                ...
                {'name': 'Владелец', 'field': 'user_id', 'value': ''},
                {'name': 'Дата с (организации)', 'field': 'create_after', 'value': ''},
                {'name': 'Дата до (организации)', 'field': 'create_before', 'value': ''},
