			...
			<Tab.Group class="overflow-hidden intro-y box">
				<Tab.Panels>
					<Tab.Panel class="p-5">
						...
						/>
						<Slug v-model="form.slug" :value="form.slug"></Slug>
...
export default {
	...
	computed: {
		pageTitle() {
			return this.tag ? 'Редактирование тега' : 'Добавление тега'
		}
	},
	methods: {
		updateOrCreate() {
		...
		update() {
			this.$inertia.put(`/tags/${this.tag.id}`, this.form)
		},
		create() {
			this.$inertia.post('/tags', this.form)
		},
	}
