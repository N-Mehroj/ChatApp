...
<template>
  ...
  <div
    class="fixed bottom-0 right-0 z-50 flex items-center justify-center w-52 h-12 mb-10 mr-10 border rounded-full shadow-md cursor-pointer box"
    @click="switchMode"
  >
    <div class="mr-4 text-slate-600 dark:text-slate-200">Темный режим</div>
    <div
      :class="[
